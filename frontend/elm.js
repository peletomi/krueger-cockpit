...
Elm.App = Elm.App || {};
Elm.App.Domain = Elm.App.Domain || {};
Elm.App.Domain.make = function (_elm) {
   "use strict";
   _elm.App = _elm.App || {};
   _elm.App.Domain = _elm.App.Domain || {};
   if (_elm.App.Domain.values) return _elm.App.Domain.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var AppInfo = F2(function (a,b) {    return {applicationId: a,ip: b};});
   var AppGroupInfo = F2(function (a,b) {    return {applicationId: a,appInfo: b};});
   return _elm.App.Domain.values = {_op: _op,AppGroupInfo: AppGroupInfo,AppInfo: AppInfo};
};
Elm.Util = Elm.Util || {};
Elm.Util.Html = Elm.Util.Html || {};
Elm.Util.Html.make = function (_elm) {
   "use strict";
   _elm.Util = _elm.Util || {};
   _elm.Util.Html = _elm.Util.Html || {};
   if (_elm.Util.Html.values) return _elm.Util.Html.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var classes = function (cls) {
      return $Html$Attributes.classList(A2($List.map,function (c) {    return {ctor: "_Tuple2",_0: c,_1: true};},A2($String.split," ",cls)));
   };
   return _elm.Util.Html.values = {_op: _op,classes: classes};
};
Elm.View = Elm.View || {};
Elm.View.Nav = Elm.View.Nav || {};
Elm.View.Nav.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Nav = _elm.View.Nav || {};
   if (_elm.View.Nav.values) return _elm.View.Nav.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Util$Html = Elm.Util.Html.make(_elm);
   var _op = {};
   var menuItem = function (menu) {
      return A2($Html.li,_U.list([]),_U.list([A2($Html.a,_U.list([$Html$Attributes.href($Basics.snd(menu))]),_U.list([$Html.text($Basics.fst(menu))]))]));
   };
   var navBar = function (menus) {
      return A2($Html.div,
      _U.list([$Html$Attributes.id("navbar"),$Util$Html.classes("collapse navbar-collapse")]),
      _U.list([A2($Html.ul,_U.list([$Util$Html.classes("nav navbar-nav")]),A2($List.map,menuItem,menus))]));
   };
   var spanIconBar = A2($Html.span,_U.list([$Html$Attributes.$class("icon-bar")]),_U.list([]));
   var navHeader = A2($Html.div,
   _U.list([$Util$Html.classes("navbar-header")]),
   _U.list([A2($Html.button,
           _U.list([$Html$Attributes.type$("button"),$Util$Html.classes("navbar-toggle collapsed")]),
           _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("sr-only")]),_U.list([])),spanIconBar,spanIconBar,spanIconBar]))
           ,A2($Html.a,_U.list([$Html$Attributes.$class("navbar-brand"),$Html$Attributes.href("#")]),_U.list([$Html.text("Elmer admin")]))]));
   var nav$ = function (menus) {
      return A2($Html.nav,
      _U.list([$Util$Html.classes("navbar navbar-inverse navbar-fixed-top")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("container")]),_U.list([navHeader,navBar(menus)]))]));
   };
   return _elm.View.Nav.values = {_op: _op,spanIconBar: spanIconBar,navHeader: navHeader,menuItem: menuItem,navBar: navBar,nav$: nav$};
};
Elm.View = Elm.View || {};
Elm.View.AppInfo = Elm.View.AppInfo || {};
Elm.View.AppInfo.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.AppInfo = _elm.View.AppInfo || {};
   if (_elm.View.AppInfo.values) return _elm.View.AppInfo.values;
   var _U = Elm.Native.Utils.make(_elm),
   $App$Domain = Elm.App.Domain.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   $Util$Html = Elm.Util.Html.make(_elm);
   var _op = {};
   var appGroupText = function (agi) {
      return A2($Basics._op["++"],agi.applicationId,A2($Basics._op["++"]," count: ",$Basics.toString($List.length(agi.appInfo))));
   };
   var viewAppInfoRow = function (appInfo) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text(appInfo.applicationId)])),A2($Html.td,_U.list([]),_U.list([$Html.text(appInfo.ip)]))]));
   };
   var viewAppInfoTable = function (apps) {
      return A2($Html.table,
      _U.list([$Util$Html.classes("table table-hover")]),
      _U.list([A2($Html.thead,
              _U.list([]),
              _U.list([A2($Html.tr,
              _U.list([]),
              _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text("Application id")])),A2($Html.td,_U.list([]),_U.list([$Html.text("Ip")]))]))]))
              ,A2($Html.tbody,_U.list([]),A2($List.map,viewAppInfoRow,apps))]));
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "Open") {
            return _U.update(model,{openedIds: A2($Set.insert,_p0._0,model.openedIds)});
         } else {
            return _U.update(model,{openedIds: A2($Set.remove,_p0._0,model.openedIds)});
         }
   });
   var isOpened = F2(function (agi,model) {    return A2($Set.member,agi.applicationId,model.openedIds);});
   var Close = function (a) {    return {ctor: "Close",_0: a};};
   var viewAppGroupInfoOpened = F3(function (address,agi,model) {
      return A2($Html.div,
      _U.list([$Util$Html.classes("panel panel-default"),A2($Html$Events.onClick,address,Close(agi.applicationId))]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("panel-heading")]),_U.list([$Html.text(appGroupText(agi))])),viewAppInfoTable(agi.appInfo)]));
   });
   var Open = function (a) {    return {ctor: "Open",_0: a};};
   var viewAppGroupInfoClosed = F3(function (address,agi,model) {
      return A2($Html.div,
      _U.list([$Util$Html.classes("well well-sm"),A2($Html$Events.onClick,address,Open(agi.applicationId))]),
      _U.list([$Html.text(appGroupText(agi))]));
   });
   var viewSingleAppGroupInfo = F3(function (address,agi,model) {
      return A2(isOpened,agi,model) ? A3(viewAppGroupInfoOpened,address,agi,model) : A3(viewAppGroupInfoClosed,address,agi,model);
   });
   var viewAppGroupInfo = F2(function (address,model) {
      var mfn = function (agi) {    return A3(viewSingleAppGroupInfo,address,agi,model);};
      return A2($Html.div,_U.list([]),A2($List.map,mfn,model.appGroupInfo));
   });
   var Model = F2(function (a,b) {    return {appGroupInfo: a,openedIds: b};});
   return _elm.View.AppInfo.values = {_op: _op
                                     ,Model: Model
                                     ,Open: Open
                                     ,Close: Close
                                     ,isOpened: isOpened
                                     ,update: update
                                     ,viewAppInfoRow: viewAppInfoRow
                                     ,viewAppInfoTable: viewAppInfoTable
                                     ,appGroupText: appGroupText
                                     ,viewAppGroupInfoOpened: viewAppGroupInfoOpened
                                     ,viewAppGroupInfoClosed: viewAppGroupInfoClosed
                                     ,viewSingleAppGroupInfo: viewSingleAppGroupInfo
                                     ,viewAppGroupInfo: viewAppGroupInfo};
};
Elm.View = Elm.View || {};
Elm.View.MainView = Elm.View.MainView || {};
Elm.View.MainView.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.MainView = _elm.View.MainView || {};
   if (_elm.View.MainView.values) return _elm.View.MainView.values;
   var _U = Elm.Native.Utils.make(_elm),
   $App$Domain = Elm.App.Domain.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Set = Elm.Set.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $View$AppInfo = Elm.View.AppInfo.make(_elm),
   $View$Nav = Elm.View.Nav.make(_elm);
   var _op = {};
   var viewMain = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$View$Nav.nav$(_U.list([{ctor: "_Tuple2",_0: "Home",_1: "#home"}]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("container")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("row")]),_U.list([A2($View$AppInfo.viewAppGroupInfo,address,model)]))]))]));
   });
   var updateMain = F2(function (action,model) {    return A2($View$AppInfo.update,action,model);});
   var Model = F2(function (a,b) {    return {appGroupInfo: a,openedIds: b};});
   return _elm.View.MainView.values = {_op: _op,Model: Model,updateMain: updateMain,viewMain: viewMain};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $View$MainView = Elm.View.MainView.make(_elm);
   var _op = {};
   var mockAppInfo = F2(function (id,num) {    return {applicationId: id,ip: A2($Basics._op["++"],"192.168.2.",$Basics.toString(num))};});
